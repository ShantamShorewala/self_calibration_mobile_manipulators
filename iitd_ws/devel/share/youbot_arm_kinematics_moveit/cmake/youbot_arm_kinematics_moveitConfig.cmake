...
if("TRUE" STREQUAL "TRUE")
  set(youbot_arm_kinematics_moveit_SOURCE_PREFIX /home/shantam/catkin_ws/src/youbot_gui/src/youbot_manipulation/youbot_arm_kinematics_moveit)
  set(youbot_arm_kinematics_moveit_DEVEL_PREFIX /home/shantam/catkin_ws/devel)
  ...
  set(youbot_arm_kinematics_moveit_INSTALL_PREFIX /home/shantam/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'youbot_arm_kinematics_moveit' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'youbot_arm_kinematics_moveit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shantam/catkin_ws/src/youbot_gui/src/youbot_manipulation/youbot_arm_kinematics_moveit/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${youbot_arm_kinematics_moveit_dep}_FOUND)
      find_package(${youbot_arm_kinematics_moveit_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${youbot_arm_kinematics_moveit_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
