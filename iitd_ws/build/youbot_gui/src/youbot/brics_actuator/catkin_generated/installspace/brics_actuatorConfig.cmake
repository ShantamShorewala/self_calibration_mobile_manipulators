...
if("FALSE" STREQUAL "TRUE")
  set(brics_actuator_SOURCE_PREFIX /home/shantam/catkin_ws/src/youbot_gui/src/youbot/brics_actuator)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'brics_actuator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shantam/catkin_ws/install/${idir}'.  ${_report}")
    endif()
